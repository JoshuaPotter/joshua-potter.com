document.write('<script>if(typeof $f == "undefined"){console.log("if video theme is selected, a video has not been connected");}</script>');document.write('<link rel="stylesheet" type="text/css" href="http://thefinancestandard.com/popup/themes/agerestriction/lightbox.css" />');var popup_domination_output = '<style>'+'#popdom-pop {'+'	width: 636px;'+'	height: 263px;'+'	margin: 0 auto;'+'	top: 30%;'+'}'+'</style>'+'<div class="popup-dom-lightbox-wrapper" id="popup_domination_lightbox_wrapper"  style="display:none">'+'	<div class="lightbox-overlay"></div>'+''+'		<div id="popdom-pop" class="popup2 lightbox-main lightbox-color-bright-green">'+'			<a href="#" class="close lightbox-close" id="popup_domination_lightbox_close">&times;</a>'+'			<div class="inner">'+'				<div class="main">'+'					<div class="button-container">'+'						<a href="http://ctrck.com/tracking202/redirect/dl.php?t202id=219491&t202kw="><img src="https://s3.amazonaws.com/g700flashlight/g700-couponV2.jpg" width="600" border="0"></a>'+'					</div>'+'				</div>'+'				<div class="clear"></div>'+'			</div>'+'		</div>'+'</div>', popup_domination_cssurl = 'http://thefinancestandard.com/popup/themes/agerestriction/lightbox.css', popup_domination_url = 'http://thefinancestandard.com/popup/' , popup_domination_popupid = '1', popup_domination_abcookie = "false" ; var popup_domination_defaults = {".name":"name",".email":"email"}, delay = 0, popup_domination_cookie_time = 1, popup_domination_center = 'Y', popup_domination_cookie_path = '/', popup_domination_show_opt = 'mouseleave', popup_domination_unload_msg = 'Would you like to signup to the newsletter before you go?', popup_domination_impression_count = 0, popup_domination_redirect = '' ;
