...
(function ($) {
     ...
     * @example $("#myloader-container).percentageLoader({
		    ...
		    value: 'SCAN'  // initialise text label to this value
		});
     */
        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                percentageText.style.top = ((settings.height / 2) - (fontSize / 1.5)).toString() + '0px';
                ...
                valueText.style.height = smallSize.toString() + '10px';
