...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var bgColor = '#fff';
		this.createPlotGraph("#earnings", uploads, downloads, plabels, pcolors, borderColor, bgColor);
		this.createPlotGraph("#follower-reach", uploads, downloads, plabels, pcolors, borderColor, bgColor);
		this.createPlotGraph("#engagements", uploads, downloads, plabels, pcolors, borderColor, bgColor);
		this.createPlotGraph("#active-campaigns", uploads, downloads, plabels, pcolors, borderColor, bgColor);
