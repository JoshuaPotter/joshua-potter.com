...
<script type="text/javascript">
        ...
        "aoColumnDefs":[{
            ...
            $("#table-project-timelog").dataTable().fnSort([[2,'desc']]);
            $("#table-tasks-timelog").dataTable().fnSort([[2,'desc']]);
...
$(".gantt").gantt({
    ...
    <?php
    if(!User::is_client()){
    $tasks = App::get_by_where('tasks',array('project'=>$project));
    }else{
    $tasks = App::get_by_where('tasks',array('project'=>$project,'visible'=>'Yes'));
    }
