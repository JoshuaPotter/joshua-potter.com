                ...
                <div class="panel panel-default wizard">
                    ...
                    <div class="step-content clearfix">
                        ...
                        <div class="step-pane <?=$step2?>" id="step2">
                            ...
                            <form class="m-b-sm form-horizontal" id='database' method="post" action="<?=base_url()?><?=config_item('index_page')?>/installer/db_setup" novalidate="novalidate">
                        ...
                        <div class="step-pane <?=$step3?>" id="step3">
                            ...
                            <form class="m-b-sm form-horizontal" id="verify" method="post" action="<?=base_url()?><?=config_item('index_page')?>/installer/verify" novalidate="novalidate">
                                <div class="form-group">
                        ...
                        <div class="step-pane <?=$step4?>" id="step4">
                            ...
                            <form class="m-b-sm form-horizontal" id="complete" method="post" action="<?=base_url()?><?=config_item('index_page')?>/installer/complete" novalidate="novalidate">
