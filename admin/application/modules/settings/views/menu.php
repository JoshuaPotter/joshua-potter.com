...
<header class="panel-heading font-bold"><i class="fa fa-list-alt"></i> <?=lang('menu_settings')?></header>
                            ...
                            <tbody>
                              ...
                              <tr class="sortable" data-module="<?=$sta->module?>" data-access="3">
                                  <td class="drag-handle"><i class="fa fa-reorder"></i></td>
                                    ...
                                    <?php }?>
                                        <td>
                                            <a data-rel="tooltip" data-original-title="<?=lang('toggle')?>" class="menu-view-toggle btn btn-xs btn-<?=($sta->visible == 1 ? 'success':'default')?>" href="#" data-role="3" data-href="<?=base_url()?>settings/hook/visible/<?=$adm->module?>"><i class="fa fa-eye"></i></a>
                                        </td>
                              </tr>
                              <?php endforeach; ?>
                            </tbody>
                            ...
                            <tbody>
                              ...
                              <tr class="sortable" data-module="<?=$cli->module?>" data-access="2">
                                  <td class="drag-handle"><i class="fa fa-reorder"></i></td>
                                    ...
                                    <?php }?>
                                        <td>
                                            <a data-rel="tooltip" data-original-title="<?=lang('toggle')?>" class="menu-view-toggle btn btn-xs btn-<?=($cli->visible == 1 ? 'success':'default')?>" href="#" data-role="2" data-href="<?=base_url()?>settings/hook/visible/<?=$adm->module?>"><i class="fa fa-eye"></i></a>
                                        </td>
                              </tr>
                                <?php endforeach; ?>
                          </tbody>
