...
<header class="panel-heading font-bold"><i class="fa fa-cogs"></i> <?=lang('translations')?></header>
            ...
            <div class="pull-right add-translation">
                ...
                <button id="add-translation" class="btn btn-sm btn-<?=config_item('theme_color');?>"><?=lang('add_translation')?></button>
            </div>
        </div></div>
              ...
              <table id="table-translations" class="table table-striped b-t b-light AppendDataTables">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=""><?=$total?></td>
                        <td class="">
                          <a data-rel="tooltip" data-original-title="<?=lang('submit_translation_note')?>" class="submit-translation btn btn-xs btn-default" href="#" data-href="<?=base_url()?>settings/translations/submit/<?=$l->name?>?settings=translations"><i class="fa fa-envelope-o"></i></a>
