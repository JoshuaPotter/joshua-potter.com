		...
		echo form_open_multipart('settings/update', $attributes); ?>
			<section class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label"><?=lang('hide_sidebar')?></label>
						<div class="col-lg-3">
							<label class="switch">
								<input type="hidden" value="off" name="hide_sidebar" />
								<input type="checkbox" <?php if(config_item('hide_sidebar') == 'TRUE'){ echo "checked=\"checked\""; } ?>  name="hide_sidebar"/>
								<span></span>
							</label>
						</div>
					</div>
