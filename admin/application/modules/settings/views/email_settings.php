<div class="row">
	<!-- Start Form test -->
				...
				<section class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-lg-3">
								<input type="password" class="form-control" value="<?=$this->encrypt->decode(config_item('smtp_pass'));?>" name="smtp_pass">
							</div>
						</div>
						<div class="form-group">
        ...
        echo form_open_multipart('settings/update', $attributes); ?>
            <section class="panel panel-default">
                <header class="panel-heading font-bold"><i class="fa fa-random"></i> <?=lang('email_piping_settings')?></header>
                <div class="panel-body">
                    <?php echo validation_errors(); ?>
                    <input type="hidden" name="settings" value="<?=$load_setting?>">
