                        ...
                        <div class="panel-body">
                                ...
                                <div class="group">
                                    ...
                                    <div class="row inline-fields">
                                        <div class="col-md-6"><strong>
                                                <?php echo ($i->individual == 0) ? lang('company_name') : lang('full_name');  ?></strong></div>
                                        <div class="col-md-6"><?=$i->company_name?></div>
                                    </div>
                                    <?php if ($i->individual == 0) { ?>
                                        <div class="row inline-fields">
                                            <div class="col-md-6"><strong><?=lang('contact_person')?></strong></div>
                                            <div class="col-md-6"><?=($i->primary_contact) ? User::displayName($i->primary_contact) : ''; ?></div>
                                        </div>
                                    <?php } ?>
                                    <div class="row inline-fields">
                            ...
                            <div class="col-md-4 small">
                                <div class="group">
                                    ...
                                    <div class="row inline-fields">
                                        <div class="col-md-4"><strong><?=lang('state_province')?></strong></div>
                                        <div class="col-md-6"><?=$i->state?></div>
                                    </div>
                                    <div class="row inline-fields">
                            ...
                            <div class="col-md-4 small">
                                <div class="group">
                                    ...
                                    <div class="row inline-fields">
                                        ...
                                        <div class="col-md-6"><a href="<?=$i->company_website?>" class="text-info" target="_blank">
                                                <?=$i->company_website?></a></div>
                                    </div>
                                    <div class="row inline-fields">
                                        ...
                                        <table id="table-client-details-1" class="table table-striped b-t b-light text-sm AppendDataTables">
                                            ...
                                            <?php foreach (Client::get_client_contacts($company) as $key => $contact) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="tel:<?=User::profile_info($contact->user_id)->phone?>"><?=User::profile_info($contact->user_id)->phone?></a></td>
                            ...
                            <div class="col-md-6">
                                <section class="panel panel-default b-top">
                                    ...
                                    <table id="table-client-details-2" class="table table-striped b-t b-light text-sm AppendDataTables">
                                        ...
                                        <?php
                                        foreach (Invoice::get_client_invoices($company) as $key => $invoice) { ?>
                                            <tr>
                            ...
                            <div class="col-md-6">
                                <section class="panel panel-default b-top">
                                    ...
                                    <table id="table-client-details-4" class="table table-striped b-t b-light text-sm AppendDataTables">
                                        ...
                                        <?php
                                        foreach (Project::by_client($company) as $key => $project) { ?>
                                            <tr>
