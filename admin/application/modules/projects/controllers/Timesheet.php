	...
	function add_time()
	{
		...
		$project = $this->input->post('project');
			...
			$this->form_validation->set_rules('task', 'Task', 'required');
				...
				$logged_time = Project::view_task($_POST['task'])->logged_time;

						$data = array('logged_time' => $time_spent + $logged_time);
						App::update('tasks',array('t_id'=>$_POST['task']),$data);
					}
				...
				$logged_time = Project::by_id($project)->time_logged;

				$data = array('time_logged' => $time_spent + $logged_time);
