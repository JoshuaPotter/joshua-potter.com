...
<?php
          ...
          echo form_open(base_url().'projects/add',$attributes); ?>
			 <?=$this->session->flashdata('form_error') ?>
				...
				<div class="col-lg-3">
					<input type="number" class="form-control" name="hourly_rate" value="<?=config_item('hourly_rate')?>">
				</div>
				</div>
				</div>
				...
				<div class="col-lg-3">
					<input type="number" class="form-control" placeholder="300" name="fixed_price" value="<?=set_value('fixed_price')?>">
				</div>
				</div>
				</div>
				...
				<div class="col-lg-3">
					<input type="number" class="form-control" placeholder="300" name="estimate_hours" value="<?=set_value('estimate_hours')?>">
				</div>
				</div>
