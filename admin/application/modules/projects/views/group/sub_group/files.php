...
<header class="header bg-white b-b clearfix">
                  ...
                  <a href="<?=base_url()?>projects/files/add/<?=$project_id?>" data-toggle="ajaxModal" class="btn btn-sm btn-<?=config_item('theme_color')?>"><?=lang('upload_file')?></a>
    ...
    <div class="table-responsive">
                  <table id="table-files" class="table table-striped b-t b-light small">
                    <thead>
                      <tr>
                        <th class="col-md-5"><?=lang('files')?></th>
                        <th class="col-sm-2"><?=lang('size')?></th>
