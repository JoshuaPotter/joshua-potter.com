                  ...
                  <table id="table-milestones" class="table table-striped b-t b-light AppendDataTables">
                    ...
                    <?php foreach (Project::has_milestones($project_id) as $key => $m) { 
                      ...
                      <tr>
                        ...
                        <td>
                        <div class="inline ">
                  <div class="easypiechart text-success" data-percent="<?=$progress?>" data-line-width="5" data-track-Color="#f0f0f0" data-bar-color="#<?php echo ($progress >= 100) ? '8ec165' : 'fb6b5b';?>" data-rotate="270" data-scale-Color="false" data-size="50" data-animate="2000">
