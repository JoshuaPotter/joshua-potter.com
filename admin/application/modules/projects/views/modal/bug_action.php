...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<button type="submit" class="btn btn-<?=config_item('theme_color');?>"><?=lang('new_bug')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
		...
		<div class="modal-body">
                ...
                <div id="file_container">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="file" name="bugfiles[]" required>
                        </div>
                    </div>
                </div>
	...
	<div class="modal-content">
		...
		<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a> 
                    <button type="submit" class="btn btn-<?=config_item('theme_color');?>"><?=lang('save_file')?></button>
		</form>
		</div>
	        </div>
        </div>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
     <img width="538" src="<?=base_url()?>resource/bug-files/<?=$file->file_name?>" alt="<?=$file->file_name?>"/>
        </div>
    </div>
</div>
