...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<button type="submit" class="btn btn-<?=config_item('theme_color')?>"><?=lang('clone_project')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
...
<div class="modal-dialog">
	...
	<div class="form-group">
		...
		<div class="modal-footer"> <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a> 
		<button type="submit" class="btn btn-<?=config_item('theme_color');?>"><?=lang('update_team')?></button>
		</form>
		<?php } ?>
...
<div class="modal-dialog">
    ...
    <div class="col-lg-12 small">
				...
				<?=lang('expense_cost')?>: 
				<strong>
				<?=Applib::format_currency($p->currency, $e->amount)?>
				</strong>
				</br>
				<?=lang('project')?>: 
				<strong>
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-footer"> <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a> 
		<button type="submit" class="btn btn-<?=config_item('theme_color')?>"><?=lang('post_reply')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<label class="col-lg-4 control-label"><?=lang('todo_item')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
					<input type="text" class="form-control" placeholder="Call James..." name="todo_item" required>
				</div>
			</div>
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<label class="col-lg-4 control-label"><?=lang('todo_item')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
					<input type="text" class="form-control" value="<?=$todo->list_name;?>" name="todo_item" required>
				</div>
			</div>
