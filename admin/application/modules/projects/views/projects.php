  ...
  <section class="hbox stretch">
    <aside>
      ...
      <?php  $no_of_tasks = App::counter('tasks',array('project' => $p->project_id)); ?>
                      ...
                      <a class="text-info small" data-toggle="tooltip" 
                      data-original-title="<?=$no_of_tasks?> <?=lang('tasks')?> | <?=$progress?>% <?=lang('done')?>" href="<?=base_url()?>projects/view/<?=$p->project_id?>">
                      <?=$p->project_title?>
                      </a>
          ...
          <?php if (time() > strtotime($p->due_date) AND $progress < 100){ ?>
