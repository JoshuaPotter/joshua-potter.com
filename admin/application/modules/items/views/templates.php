<section id="content"> <section class="vbox"> <section class="scrollable padder">
	...
	<header class="panel-heading"> <i class="fa fa-navicon"></i> <a href="<?=base_url()?>items/save_task" class="btn btn-xs btn-<?=config_item('theme_color');?> pull-right" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('add_task')?></a> <?=lang('project_tasks')?></header>
	...
	<div class="table-responsive">
		<table id="table-templates-1" class="table table-striped b-t b-light text-sm AppendDataTables">
			<thead>
				...
				<tr>
					<td>
					<a class="text-info" href="#" data-original-title="<?=$task->task_desc?>" data-toggle="tooltip" data-placement="right">
					<?=$task->task_name?></a></td>
					<td><?=$task->visible?></td>
...
<!-- Invoice Items -->
	...
	<a href="<?=base_url()?>items/add_item" class="btn btn-xs btn-<?=config_item('theme_color');?> pull-right" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('new_item')?></a></header>
	...
	<div class="table-responsive">
		<table id="table-templates-2" class="table table-striped b-t b-light text-sm AppendDataTables">
			<thead>
				...
				<tr>
				<td>
				<a class="text-info" href="#" data-original-title="<?=$item->item_desc?>" data-toggle="tooltip" data-placement="left" title = "">
				<?=$item->item_name?>
				</a>
