                                    ...
                                    <?php foreach ($backups as $file) : ?>
                                        <tr>
                                            <td>
                                                ...
                                                <a href="<?=base_url()?>updates/getFile/<?=$file?>" class="text-info"><?=$file?></a>
                                                <a href="<?=base_url()?>updates/delFile/<?=$file?>" class="btn btn-danger btn-xs pull-right" onclick="return confirm('Are you sure you want to delete this file?');"><?=lang('delete')?></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
