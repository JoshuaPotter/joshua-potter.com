                    ...
                    <div class="col-md-12">
                            ...
                            <?php if (User::is_admin() || User::perm_allowed(User::get_id(),'edit_all_invoices')) : ?>
                                ...
                                <a href="<?= base_url() ?>invoices/items/insert/<?=$inv->inv_id ?>"
                                   title="<?= lang('item_quick_add') ?>" class="btn btn-sm btn-dark btn-responsive" data-toggle="ajaxModal">
                                ...
                                <?php if ($inv->show_client == 'Yes') { ?>
                                    ...
                                    <a class="btn btn-sm btn-<?=config_item('theme_color')?> btn-responsive"
                                       href="<?= base_url() ?>invoices/hide/<?=$inv->inv_id ?>" data-toggle="tooltip"
                                       data-original-title="<?=lang('hide_to_client') ?>" data-placement="bottom">
                                        <i class="fa fa-eye-slash"></i></a>

                                <?php } else { ?>


                                    <a class="btn btn-sm btn-dark btn-responsive" href="<?= base_url() ?>invoices/show/<?= $inv->inv_id ?>"
                            ...
                            <?php if (Invoice::get_invoice_due_amount($inv->inv_id) > 0) : ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php if ($inv->allow_stripe == 'Yes') : ?>
                                        ...
                                        <button id="customButton" class="btn btn-sm btn-<?=config_item('theme_color')?> btn-responsive"><?=lang('via_stripe')?>
                                        </button>
                            ...
                            <?php if ($inv->recurring == 'Yes') { ?>
                                <?php if(User::is_admin() || User::perm_allowed(User::get_id(),'edit_all_invoices')){ ?>
                                    ...
                                    <a class="btn btn-sm btn-dark btn-responsive" href="<?= base_url() ?>invoices/stop_recur/<?=$inv->inv_id?>"
                            ...
                            <?php if (User::is_admin() || User::perm_allowed(User::get_id(),'edit_all_invoices')) { ?>
                                ...
                                <a href="<?= base_url() ?>invoices/edit/<?=$inv->inv_id?>"
                                   class="btn btn-sm btn-<?=config_item('theme_color')?> btn-responsive" data-original-title="<?=lang('edit_invoice')?>"
                            ...
                            <?php } if (User::is_admin() || User::perm_allowed(User::get_id(),'delete_invoices')) { ?>
                                ...
                                <a href="<?= base_url() ?>invoices/delete/<?=$inv->inv_id?>" class="btn btn-sm btn-danger btn-responsive"
                            ...
                            <?php if (config_item('pdf_engine') == 'invoicr') : ?>
                                <a href="<?= base_url() ?>fopdf/invoice/<?= $inv->inv_id ?>" class="btn btn-sm btn-dark  btn-responsive pull-right">
                                    <i class="fa fa-file-pdf-o"></i><?= lang('pdf') ?>
                                </a>


                            <?php elseif (config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?= base_url() ?>invoices/pdf/<?= $inv->inv_id ?>" class="btn btn-sm btn-dark pull-right  btn-responsive">
                                    <i class="fa fa-file-pdf-o"></i><?= lang('pdf') ?>
                                </a>
                    ...
                    <section class="scrollable wrapper">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <div>
                                    <?=lang('invoice_date')?>
                                    <span class="col-xs-3 no-gutter-right pull-right">
                                    <strong>
                            ...
                            <?php if ($inv->tax > 0.00): ?>
                                <tr>
                                    <td colspan="<?= $showtax ? '7' : '5' ?>" class="text-right no-border">
                                        <strong><?= lang('tax') ?> <?=Applib::format_tax($inv->tax)?>%</strong></td>
                                    <td class="text-right">
