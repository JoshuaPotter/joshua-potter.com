    ...
    <section class="hbox stretch">
                    ...
                    <div class="row m-t-sm">
                        <div class="col-sm-8 m-b-xs">
                            ...
                            <?php if(User::can_edit_estimate()) { ?>
                                ...
                                <a href="<?=base_url()?>estimates/items/insert/<?=$estimate->est_id?>" title="<?=lang('item_quick_add')?>" class="btn btn-sm btn-<?=config_item('theme_color');?>" data-toggle="ajaxModal">
                                    <i class="fa fa-list-alt text-white"></i> <?=lang('items')?></a>

                                <a data-original-title="<?=lang('convert_to_invoice')?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-sm btn-<?=config_item('theme_color')?> <?php if($estimate->invoiced == 'Yes' OR $estimate->client == '0'){ echo "disabled"; } ?>" href="<?=base_url()?>estimates/convert/<?=$estimate->est_id?>" data-toggle="ajaxModal"
                                   title="<?=lang('convert_to_invoice')?>">
                                    <?=lang('convert_to_invoice')?></a>


                                <?php if($estimate->show_client == 'Yes'){ ?>
                                <a class="btn btn-sm btn-<?=config_item('theme_color')?>" href="<?=base_url()?>estimates/hide/<?=$estimate->est_id?>" data-toggle="tooltip" data-placement="bottom" data-title="<?=lang('hide_to_client')?>"><i class="fa fa-eye-slash"></i>
                                    </a><?php }else{ ?>
                                    <a class="btn btn-sm btn-dark" href="<?=base_url()?>estimates/show/<?=$estimate->est_id?>" data-toggle="tooltip" data-placement="bottom" data-title="<?=lang('show_to_client')?>"><i class="fa fa-eye"></i> 
                                    </a>
                                <?php } ?>
                            <?php } ?>
            ...
            <?php } ?>
                ...
                <section class="scrollable wrapper ie-details">
                        ...
                        <div class="col-xs-6">
                            ...
                            <p>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <?php if($client->VAT != ''){ ?>
                                    <span class="col-xs-3 no-gutter"><?=lang('company_vat') ?>:</span>
                                    <span class="col-xs-9 no-gutter"><?php echo $client->VAT; ?>
                                    </span>
                                    <?php } ?>
                                    </p>
                                </div>
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="line"></div>
                        <table id="est-details" class="table sorted_table" type="estimates"><thead>
                            <tr>
                                <th></th>
        <?php if ($showtax) : ?>
        ...
        <?php else : ?>
                    ...
                    <?=Applib::format_currency($estimate->currency,Estimate::sub_total($estimate->est_id)); ?>
                            ...
                            <tr>
                                <td colspan="<?= $showtax ? '7' : '5' ?>" class="text-right no-border">
                                    <strong><?=lang('tax')?> <?=Applib::format_tax($estimate->tax);?>%</strong></td>
                                <td class="text-right">
