...
$route['api/v1/invoices/id/(:num)/status'] = "api_v1/invoices/status/id/$1";
$route['api/v1/invoices/id/(:num)/items'] = "api_v1/invoices/items/id/$1";
$route['api/v1/invoices/id/(:num)'] = "api_v1/invoices/invoice/id/$1";
