...
# Generation Time: 2016-04-30 16:44:43 +0000
# ************************************************************
...
VALUES
  ...
  ('beta_updates','FALSE'),
  ('billing_email','billing@gitbench.com'),
  ('billing_email_name','Gitbench Sales'),
  ('bitcoin_address',''),
  ('bitcoin_api_key',''),
  ('braintee_live','TRUE'),
  ...
  ('company_domain','https://gitbench.com'),
  ...
  ('invoice_start_no','1'),
  ('languages',''),
  ('last_check','1461870145'),
  ('last_seen_activities','1457414511'),
  ('locale','en_US'),
  ...
  ('stripe_private_key',''),
  ('stripe_public_key',''),
  ('support_email','support@gitbench.com'),
  ('support_email_name','Gitbench Support'),
  ('swap_to_from','TRUE'),
  ...
  ('website_name','Gitbench Studio'),
  ('xrates_app_id', ''),
  ('xrates_check','2016-02-28');
...
VALUES
  ('AED','United Arab Emirates Dirham','ARE',3.67284),
  ('AUD','Australian Dollar','$',1.40326),
  ('BRL','Brazilian Real','R$',3.99551),
  ('CAD','Canadian Dollar','$',1.35137),
  ('CHF','Swiss Franc','Fr',0.99687),
  ('CLP','Chilean Peso','$',693.15910),
  ('CNY','Chinese Yuan','¥',6.53986),
  ('CZK','Czech Koruna','Kč',24.71836),
  ('DKK','Danish Krone','kr',6.82381),
  ('EUR','Euro','€',0.91471),
  ('GBP','British Pound','£',0.72082),
  ('HKD','Hong Kong Dollar','$',7.77557),
  ('HUF','Hungarian Forint','Ft',284.95720),
  ('IDR','Indonesian Rupiah','Rp',13414.45000),
  ('ILS','Israeli New Shekel','₪',3.91340),
  ('INR','Indian Rupee','INR',68.75659),
  ('JPY','Japanese Yen','¥',113.99410),
  ('KES','Kenya shillings','KSH',102.07630),
  ('KRW','Korean Won','₩',1241.91835),
  ('MXN','Mexican Peso','$',18.27786),
  ('MYR','Malaysian Ringgit','RM',4.20485),
  ('NOK','Norwegian Krone','kr',8.68787),
  ('NZD','New Zealand Dollar','$',1.50817),
  ('PHP','Philippine Peso','₱',47.49180),
  ('PKR','Pakistan Rupee','₨',104.80400),
  ('PLN','Polish Zloty','zł',4.00116),
  ('RUB','Russian Ruble','₽',76.36458),
  ('SEK','Swedish Krona','kr',8.56505),
  ('SGD','Singapore Dollar','$',1.40790),
  ('THB','Thai Baht','฿',35.75747),
  ('TRY','Turkish Lira','₺',2.99173),
  ('TWD','Taiwan Dollar','$',33.36010),
  ('USD','US Dollar','$',1.00000),
  ('VEF','Bolívar Fuerte','Bs.',6.31701),
  ('ZAR','South African Rand','R',16.16406);
...
LOCK TABLES `fx_departments` WRITE;
/*!40000 ALTER TABLE `fx_departments` DISABLE KEYS */;

INSERT INTO `fx_departments` (`deptid`, `deptname`, `depthidden`)
VALUES
  (1,'Sales',NULL);

/*!40000 ALTER TABLE `fx_departments` ENABLE KEYS */;
UNLOCK TABLES;
